...
/**
 * The rendering plan produced by the [SettingsGraphBuilder] Graph and
 * consumed by [SettingsColumn].
 *
 * Built fresh on every recomposition from the Graph block, so it always reflects the latest values
