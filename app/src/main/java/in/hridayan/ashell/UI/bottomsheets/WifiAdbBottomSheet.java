...
public class WifiAdbBottomSheet {
    ...
    public static void showPairAndConnectBottomSheet(Context context, Activity activity) {
        ...
        View bottomSheetView = LayoutInflater.from(activity)
                .inflate(R.layout.bottom_sheet_pair_and_connect, null);
    ...
    private static void initializeViewsAndSetupListeners(
            Context context, Activity activity, BottomSheetDialog bottomSheetDialog, View bottomSheetView) {
        ...
        TextInputEditText connectingIPEditText = bottomSheetView.findViewById(R.id.ipAddressConnectEditText);
        TextInputEditText connectingPortEditText = bottomSheetView.findViewById(R.id.connectPortEditText);
        ...
        TextInputLayout connectingIPLayout = bottomSheetView.findViewById(R.id.ipAddressConnectInputLayout);
        TextInputLayout connectingPortLayout = bottomSheetView.findViewById(R.id.connectPortInputLayout);
        ...
        LottieAnimationView connectLoadingAnim = bottomSheetView.findViewById(R.id.loading_anim_on_connect);
        ...
        pairButton.setOnClickListener(v -> handlePairing(
                context, v, pairButton, pairLoadingAnim, 
                pairingIPEditText, pairingPortEditText, pairingCodeEditText,
                pairingIPLayout, pairingPortLayout, pairingCodeLayout,
                connectLayout, connectingIPEditText));

        connectButton.setOnClickListener(v -> handleConnection(
                context, v, activity, bottomSheetDialog, 
                connectButton, connectLoadingAnim, 
                connectingIPEditText, connectingPortEditText,
                connectingIPLayout, connectingPortLayout));
    }
    ...
    private static void handlePairing(
            Context context, View view, MaterialButton pairButton, LottieAnimationView loadingAnim,
            TextInputEditText ipEditText, TextInputEditText portEditText, TextInputEditText codeEditText,
            TextInputLayout ipLayout, TextInputLayout portLayout, TextInputLayout codeLayout,
            LinearLayout connectLayout, TextInputEditText connectingIPEditText) {
        ...
        WifiAdbShell.pair(context, ip, port, code, new WifiAdbShell.PairingCallback() {
            @Override
            public void onSuccess() {
                HapticUtils.weakVibrate(view);
                stopLoadingAnimation(pairButton, loadingAnim, context.getString(R.string.paired));
            ...
            public void onFailure(String errorMessage) {
                stopLoadingAnimation(pairButton, loadingAnim, context.getString(R.string.pair));
    ...
    private static void handleConnection(
            Context context, View view, Activity activity, BottomSheetDialog bottomSheetDialog,
            MaterialButton connectButton, LottieAnimationView loadingAnim,
            TextInputEditText ipEditText, TextInputEditText portEditText,
            TextInputLayout ipLayout, TextInputLayout portLayout) {
        ...
        WifiAdbShell.connect(context, ip, port, new WifiAdbShell.ConnectingCallback() {
            @Override
            public void onSuccess() {
                HapticUtils.weakVibrate(view);
                stopLoadingAnimation(connectButton, loadingAnim, context.getString(R.string.connect));
                bottomSheetDialog.dismiss();
                ToastUtils.showToast(context, context.getString(R.string.connected), ToastUtils.LENGTH_SHORT);
            }

            @Override
            public void onFailure(String errorMessage) {
                stopLoadingAnimation(connectButton, loadingAnim, context.getString(R.string.connect));
                ToastUtils.showToast(context, context.getString(R.string.connection_failed), ToastUtils.LENGTH_SHORT);
            }
        });
    }

    private static boolean validateInputs(Context context, String ip, String port, String code,
                                          TextInputLayout ipLayout, TextInputLayout portLayout, TextInputLayout codeLayout) {
        ...
        if (codeLayout != null && code.isEmpty()) codeLayout.setError(context.getString(R.string.must_fill));
        return isValid;
    }

    private static void startLoadingAnimation(MaterialButton button, LottieAnimationView animationView) {
        animationView.setVisibility(View.VISIBLE);
        button.setText(null);
    }

    private static void stopLoadingAnimation(MaterialButton button, LottieAnimationView animationView, String buttonText) {
