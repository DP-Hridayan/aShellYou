...
/**
 * Dialog shown when QR or manual pairing connection fails
 * (after pairing succeeds but connection to the device fails)
 */
@Composable
fun PairConnectFailedDialog(
        ...
        Surface(
            ...
            Column(
                ...
                BulletPointsTextLayout(
                    ...
                    textLines = splitStringToLines(stringResource(R.string.pair_connect_failed_message)),
