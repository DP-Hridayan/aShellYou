...
public class Commands {
  ...
  public static List<CommandItems> commandList() {
    ...
    mCommands.add(
        new CommandItems(
            "pm hide <package>", "Hide an app from launcher", "pm hide com.android.package"));
    ...
    mCommands.add(
        new CommandItems(
            "pm unhide <package>", "Unhide an app from launcher", "pm unhide com.android.package"));
    mCommands.add(
        new CommandItems(
            "pm uninstall <package>", "Uninstall an app", "pm uninstall com.android.package"));
    mCommands.add(
        new CommandItems(
