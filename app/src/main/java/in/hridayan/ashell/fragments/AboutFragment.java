...
public class AboutFragment extends Fragment implements AboutAdapter.AdapterListener, FetchLatestVersionCodeCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initializeItems();
        adapter = new AboutAdapter(items, getContext(), requireActivity());
    ...
    private void initializeItems() {
        ...
        try {
            ...
            items.add(new Category.AppItem("id_version", getString(R.string.version), version, R.drawable.ic_version_tag));
    ...
    public void onResult(int result) {
        switch (result) {
            ...
            case Preferences.UPDATE_NOT_AVAILABLE:
                ToastUtils.showToast(requireContext(), R.string.already_latest_version, ToastUtils.LENGTH_SHORT);
                break;
            case Preferences.CONNECTION_ERROR:
                ToastUtils.showToast(requireContext(), R.string.check_internet, ToastUtils.LENGTH_SHORT);
                break;
            default:
                break;
        }
