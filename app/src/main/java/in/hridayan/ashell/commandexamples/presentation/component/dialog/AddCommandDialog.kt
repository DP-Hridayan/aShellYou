    ...
    CustomDialog(
        onDismiss = onDismiss, content = {
            Column(
                ...
                ExampleInputField(
                    example, viewModel::onExampleChange, exampleError, modifier = Modifier.Companion
                )
...
@Composable
fun LabelInputField(value: String, onValueChange: (String) -> Unit, modifier: Modifier) {
