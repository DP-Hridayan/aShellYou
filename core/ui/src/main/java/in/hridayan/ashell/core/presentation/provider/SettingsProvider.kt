...
import `in`.hridayan.settingsdsl.dsl.settingsGraph
import `in`.hridayan.settingsdsl.model.ButtonGroupOption
import `in`.hridayan.settingsdsl.model.SettingsGraph

@Composable
fun rememberSettingsGraphs(navController: NavController): List<SettingsGraph> {
    return remember(navController) {
        listOf(
            settingsGraph(R.string.settings, { navController.navigate(NavRoutes.SettingsScreen) }) {
                group {
            ...
            settingsGraph(
                R.string.dark_theme,
                { navController.navigate(NavRoutes.DarkThemeScreen) }) {
            ...
            settingsGraph(R.string.behavior, { navController.navigate(NavRoutes.BehaviorScreen) }) {
            ...
            settingsGraph(R.string.about, { navController.navigate(NavRoutes.AboutScreen) }) {
            ...
            settingsGraph(
                R.string.ai_models,
                { navController.navigate(NavRoutes.AiModelsScreen) }) {
