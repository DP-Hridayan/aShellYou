...
import `in`.hridayan.ashell.core.navigation.animatedComposable
...
/** Thin HiltViewModel used solely to expose [in.hridayan.ashell.logcat.data.session.LogcatSessionHolder] to NavGraph composables. */
@HiltViewModel
