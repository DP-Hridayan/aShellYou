package `in`.hridayan.ashell.settings.presentation.page.search.graph.constants

internal object SettingsGraphId {
    const val ABOUT = "about_graph"
    const val AI_MODELS = "ai_models_graph"
    const val AUTO_UPDATE = "auto_update_graph"
