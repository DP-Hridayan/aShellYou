package `in`.hridayan.ashell.settings.presentation.components.svg.vectors
    ...
    return Builder(
        ...
        addPath(
            pathData = PathParser().parsePathString(
                "M407.321,104.9l8.23,3.899c-3.376,-4.711 -6.284,-12.068 -7.841,-17.922 -2.637,5.453 -6.887,12.126 -11.094,16.112l8.698,-2.238c-5.36,26.268 -25.519,45.126 -48.604,45.126l-0.327,0.949c24.113,0 45.466,-18.596 50.938,-45.925Z"
            )
                .toNodes(),
        ...
        addPath(
            pathData = PathParser().parsePathString(
                "M382.442,64.876h52c2.206,0 4,1.794 4,4 0,2.206 -1.794,4 -4,4h-52c-2.206,0 -4,-1.794 -4,-4 0,-2.206 1.794,-4 4,-4Z"
            )
                .toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.onSurface),
        )
        ...
        addPath(
            pathData = PathParser().parsePathString(
                "M356.638,191.893m-25.133,0a25.133,25.133 0,1 1,50.266 0a25.133,25.133 0,1 1,-50.266 0"
            )
                .toNodes(),
            fill = SolidColor(MaterialTheme.colorScheme.primary),
        )
