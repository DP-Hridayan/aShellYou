...
/**
 * [ExternalDeviceShell] implementation that runs commands on the user's own
 * device connected via Wireless Debugging (isOwnDevice == true).
 */
@Singleton
class WifiAdbOwnDeviceShell @Inject constructor(
    ...
    override val isConnected: Boolean
        get() = WifiAdbConnection.currentState is WifiAdbState.Connected &&
                WifiAdbConnection.currentDevice.value?.isOwnDevice == true
}
